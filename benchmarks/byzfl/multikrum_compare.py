...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark ByzFL's Multi-Krum aggregator.")
    parser.add_argument("--num-grads", type=int, default=80, help="Number of gradients (n).")
    parser.add_argument("--grad-dim", type=int, default=65536, help="Gradient dimension.")
    parser.add_argument("--f", type=int, default=20, help="Number of Byzantine gradients.")
