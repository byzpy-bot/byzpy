...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark ByzFL's Coordinate-wise Trimmed Mean.")
    ...
    parser.add_argument("--f", type=int, default=8, help="Trim parameter (drop f values per side).")
