...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark the Empire attack using simplified API.")
    parser.add_argument("--num-grads", type=int, default=128, help="Number of honest gradients.")
    ...
    parser.add_argument("--scale", type=float, default=-1.0, help="Empire scaling factor.")
...
def _time_direct(attack: EmpireAttack, grads: Sequence[torch.Tensor], *, iterations: int, warmup: int) -> float:
